...
AbRect rect2x10 = {abRectGetBounds, abRectCheck, {10, 2}}; /**< 10x10 rectangle */
...
Layer ball = {		/**< Layer with the ball */
  (AbShape *)&circle8,
  ...
  Region shapeBoundary;
   for (; ml; ml = ml->next) {
	...
	score = 0;
	 ...
	 (shapeBoundary.botRight.axes[0] < pong.pos.axes[0] + 10 &&
	  shapeBoundary.botRight.axes[0] > pong.pos.axes[0] - 10)){
